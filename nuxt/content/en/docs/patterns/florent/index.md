...
{% include figure.html
    url='/img/patterns/florent/florent16.svg'
    description='Protect this area from beeing pocked through by the plastic brim'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent01.jpg'
    description='Marking the end of the dart'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent02.jpg'
    description='Ballanced dart'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent03.jpg'
    description='Pins'
%}
{% include figure.html
    url='/img/patterns/florent/florent04.jpg'
...
{% include figure.html
    url='/img/patterns/florent/florent05.jpg'
    description='The seam allowances are trimmed, clipped and pressed flat open'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent06.jpg'
    description='The brim is prepared'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent07.jpg'
    description='Preparation for stitching the linig to the cap'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent08.jpg'
    description='Joining the lining, finishing by hand '
%}
...
{% include figure.html
    url='/img/patterns/florent/florent09.jpg'
    description='a nice crisp basted edge'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent10.jpg'
    description='This tape will keep the cap from stretching'
%}

Trim the ends of the tape in an arrow shape to keep it from poking out.
{% include figure.html
    url='/img/patterns/florent/florent11.jpg'
    description='It's all in the smallest details'
%}

Divide the tape in two with two pins
{% include figure.html
    url='/img/patterns/florent/florent12.jpg'
    description='Obviously, the cap is symetrical, so we might as well distribute the tape evenly on both sides'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent13.jpg'
    description='bothe edges of the tape are slipstitched, and the edge of the cap is topstitched'
%}
...
{% include figure.html
    url='/img/patterns/florent/florent14.jpg'
    description='Pin it in place'
%}
{% include figure.html
    url='/img/patterns/florent/florent15.jpg'
    description='Stitch it in place, from the lining side'
%}
## See also
