...
{% include figure.html 
    url="/img/blog/roundup-2018-02/jaeger.png" 
    description="Jaeger is ready, but I haven't made one yet" 
%}

Those of you with good memories may remember that I mentioned last month that I would
perhaps release this during February. But, as I already foreshadowed, I did not find the time
to make one.
...
Truth be told, I'm still not sure where I find the time to make that Carlton coat.

Anyway, all this to say that the pattern is ready, except that I've never made it. 
