...
- If a `pattern` request parameter is set:
  ...
  - This info will be themed with [`Themes/Info::themePatternInfo`](/class/themes/info#themepatterninfo) 
...
- If a `pattern` request parameter is not set:
  ...
  - This info will be themed with [`Themes/Info::themeInfo`](/class/themes/info#themeinfo)
  - It will then be passed on to [`Context::setResponse`](/class/context#setresponse)
...
- If it doesn't
  - We'll let the channel bail out by calling [`Channels/Channel::handleInvalidResponse`](/class/channels/channel#handleinvalidresponse)
...
- If it does not
  - We'll let the channel bail out by calling [`Channels/Channel::handleInvalidRequest`](/class/channels/channel#handleinvalidrequest)
- We'll check whether [`Channels/Channel::isValidResponse`](/class/channels/channel#isvalidresponse) returns `true`
- If it does:
  - We'll send out the response by calling [`Response::send`](/class/response#send)
- If it doesn't
...
- If it does:
  ...
  - If the `mode` request parameter is `options`:
    ...
    - We'll set the pattern options via [`Pattern::addOptions`](/class/patterns/pattern#addoptions)
